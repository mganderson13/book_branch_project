const About = () => {
    ...
    <>
        ...
        Book Branch was created with a React front end and Node back end. To save user data Book Branch uses a MongoDB database and is hosted using Google's Firebase hosting services.</p>
